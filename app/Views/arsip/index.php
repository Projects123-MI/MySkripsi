                                 ...
                                 <tbody>
                                     <?php foreach ($arsips as $key => $arsip) : ?>
                                         <tr>
                                             ...
                                             <td align="center"><a href="<?= base_url('arsip/editFile/'.$arsip['id']); ?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                             <a target="_blank" href="<?= base_url() . "/uploads/lampiran/" . $arsip['lampiran']  ?>"><img width="100px" class="img-thumbnail" src="<?= base_url() . "/uploads/lampiran/" . $arsip['lampiran']  ?>" alt=""></a></td>
                                             <td><?= $arsip['ket'] ?></td>
                                             <td align="center">
